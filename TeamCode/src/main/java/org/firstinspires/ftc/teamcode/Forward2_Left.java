...
// Created  for 16887.
@Autonomous(name="Forward 50, then Left", group="Simple")
//@Disabled
public class Forward2_Left extends BaseRobot {
    private int stage = 0;
    @Override
    public void init() {
        super.init();
    ...
    public void loop() {
        ...
        if (DEBUG) telemetry.addData("Forward 50, then LEFT: ", stage);
        super.loop();
    }
}
